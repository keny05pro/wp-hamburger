...
<?php if (have_posts()) :
	while (have_posts()) : the_post(); ?>
		<main class="l-main single c-global-container c-global-container--sub" <?php post_class(); ?>>
			...
			<section class="l-main__recommend">
				<div class="l-main__recommend__info">
					<?php if (!empty(get_field('recommend_title'))): ?>
						<h2 class="p-recommend__title">おすすめ情報</h2>
